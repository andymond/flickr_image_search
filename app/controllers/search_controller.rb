class SearchController < ApplicationController
  ...
  def index
    conn = Faraday.new
    response = conn.get("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=#{ENV['flickr_api_key']}&format=json&nojsoncallback=1&safe_search=1&text=#{params[:search_field]}")
